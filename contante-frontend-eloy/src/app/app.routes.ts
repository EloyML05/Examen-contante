...
import { UsuarioAdminPlistParRoutedComponent } from './component/usuario/usuario.admin.plistpar.routed copy/usuario.admin.plistpar.routed.component';
...
export const routes: Routes = [
  ...
  { path: 'admin/usuario/plistpar', component: UsuarioAdminPlistParRoutedComponent },
